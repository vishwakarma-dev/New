...
const Canvas: React.FC<CanvasProps> = ({ page, viewMode, selectedElementId, onSelectElement, onDeleteElement, onMoveElement, isPreviewing = false, onOpenAddMenu, onDropNewElement, onAddElement, showRulers = false }) => {
    ...
    return (
        <Box sx={{
            ...
            {!isPreviewing && <Rulers show={showRulers} />}
             <Box sx={{
                mx: 'auto',
